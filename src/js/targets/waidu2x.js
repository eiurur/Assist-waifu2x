// import $ from 'jquery';
// import { CHROME_RUNTIME_ID, ENDPOINT } from '../configs';
// import { utils } from '../utils';

// (function() {
//   const isProduction = chrome.runtime.id === CHROME_RUNTIME_ID;
//   const DEST_URL = isProduction ? ENDPOINT.PROD : ENDPOINT.ENV;
...
//         utils.saveBlobImage({ data: data.body.data, type: data.type });
